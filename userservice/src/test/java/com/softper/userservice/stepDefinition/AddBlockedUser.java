...
public class AddBlockedUser {
    ...
    UserBoundResponse blocked;
    UserService userService = new UserService();
    UserBoundResponse blockedResponse = new UserBoundResponse();
    ...
    public void you_don_t_select_the_Block_user_option() {
        ...
        blockedResponse = new UserBoundResponse("blockedResponse","blocked response",0);
    }
